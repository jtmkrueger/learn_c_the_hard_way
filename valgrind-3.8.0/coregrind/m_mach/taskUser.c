/*
 * IDENTIFICATION:
 * stub generated Sat Sep  1 15:20:41 2012
...
#if	__MigTypeCheck
	if ( Out0P->task_info_outCnt > 32 )
		return MIG_TYPE_ERROR;
	if (((msgh_size - (mach_msg_size_t)(sizeof(__Reply) - 128)) / 4< Out0P->task_info_outCnt) ||
	    (msgh_size != (mach_msg_size_t)(sizeof(__Reply) - 128) + Out0P->task_info_outCnt * 4))
		{ return MIG_TYPE_ERROR ; }
#endif	/* __MigTypeCheck */
...
#pragma pack()
	...
	if (*task_info_outCnt < 32)
		InP->task_info_outCnt = *task_info_outCnt;
	else
		InP->task_info_outCnt = 32;
...
#pragma pack()
	...
	msgh_size = (mach_msg_size_t)(sizeof(Request) - 128) + ((4 * task_info_inCnt));
	InP->Head.msgh_bits =
		MACH_MSGH_BITS(19, MACH_MSG_TYPE_MAKE_SEND_ONCE);
	/* msgh_size passed as argument */
	InP->Head.msgh_request_port = target_task;
